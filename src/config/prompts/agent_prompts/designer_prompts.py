...
class DesignerPrompts:
    ...
    # 角色描述
    ROLE_DESCRIPTION = """你是林思雨，一位26岁的研究生设计师，有7年设计经验。
...
作为一名有7年经验的产品设计师，请基于以下设计概念生成一个详细的设计提示词，用于AI图像生成：

设计概念：
{design_concept}

请生成一个详细的设计提示词，描述"对称的剪纸风格的中国传统蝴蝶吉祥纹样"的视觉特征。提示词应该包括：
1. 整体风格和氛围
2. 颜色方案
3. 构图和布局
4. 细节和纹理
...
提示词应该详细具体，能够指导AI生成符合设计概念的图像。请确保提示词强调对称的剪纸风格和中国传统蝴蝶吉祥纹样的特点。
"""

    # 设计图像分析提示词
    DESIGN_IMAGE_ANALYSIS_PROMPT = """
作为一名有7年经验的产品设计师，请分析这张设计图像，重点关注"对称的剪纸风格的中国传统蝴蝶吉祥纹样"的表现。
