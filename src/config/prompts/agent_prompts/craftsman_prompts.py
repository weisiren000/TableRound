...
class CraftsmanPrompts:
    ...
    # 角色描述
    ROLE_DESCRIPTION = """你是巴雅尔，一位60岁的蒙古族传统剪纸承人，从事蒙古族剪纸技艺长达40年。
...
作为一名有着40年经验的蒙古族传统剪纸承人，请评估以下剪纸文创产品设计方案：
...
作为一名有着40年经验的蒙古族传统剪纸承人，请为以下剪纸文创产品设计方案建议适合的材料：
